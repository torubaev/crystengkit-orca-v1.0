...
def build_tddft_block(settings: Dict) -> str:
    ...
    TDA, NRoots, MaxDim, MaxIter, Triplets, IRoot, and IRootMult are accepted
    by ORCA 6.0.1.
    Singlet states are generated by default; ORCA 6.0.1 rejects a ``Singlets``
    keyword in the CIS/TDDFT block, so it is intentionally not emitted.
