...
"""
    ...
    def test_emission_filename_replaces_absorption_suffix_and_uses_actual_method(self):
        self.assertEqual(
            emission_filename_stem("mol_CAM-B3LYP_def2-TZVP_CHCl3_td-dft_absorption.out", "TDA", "emission", 2),
            "mol_CAM-B3LYP_def2-TZVP_CHCl3_tda_emission_S2",
        )
